...
@section('content')
    ...
    <div class="row p-5">
        ...
        <div class="col-md-6 py-1">
            <img src="{{asset('assets/franchise/ny1.png')}}" alt="" class="img-fluid" data-lightbox="{{asset('assets/franchise/ny1.png')}}">
        </div>

        <div class="col-md-6 py-1">
            <img src="{{asset('assets/franchise/ny2.png')}}" alt="" class="img-fluid" data-lightbox="{{asset('assets/franchise/ny2.png')}}">
        </div>
