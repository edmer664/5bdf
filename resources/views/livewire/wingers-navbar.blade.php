    ...
    <div class="container-xl d-flex flex-column flex-sm-row justify-content-between align-items-lg-center py-4">
        ...
        <ul class=" list-unstyled d-flex gap-3 gap-md-5 align-items-lg-center  m-0">
            <li class="fw-5"><a class="text-decoration-none text-white"
                                href="{{route('5bdf.wingers.careers')}}">Careers</a></li>
            <li class="fw-5"><a class="text-decoration-none text-white" href="{{route('5bdf.wingers.promotions')}}">Promotions</a>
            </li>
            <li class="fw-5"><a class="text-decoration-none text-white" href="{{route('5bdf.wingers.franchise')}}">Franchise</a>
            </li>
            <li class="fw-5"><a class="text-decoration-none text-white"
                                href="{{route('5bdf.wingers.store')}}">Branches</a></li>
        </ul>
    </div>
</div>
