...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <img class="img-fluid h-100 rounded" style="object-fit: cover"
                        src="{{ asset('assets/stores2/wu/cb.jpg') }}" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="row p-5">
        ...
        <div class="col-md-6 py-1">
            <img src="{{ asset('assets/franchise/wu1.png') }}" alt="" class="img-fluid"
                data-lightbox="{{ asset('assets/franchise/wu1.png') }}  ">
        </div>

        <div class="col-md-6 py-1">
            <img src="{{ asset('assets/franchise/wu2.png') }}" alt="" class="img-fluid"
                data-lightbox="{{ asset('assets/franchise/wu2.png') }}  ">
        </div>
