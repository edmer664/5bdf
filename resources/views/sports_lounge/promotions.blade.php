            ...
            <div class="" id="promotion-section">
                @if (count($promotions) > 0)
                    @foreach ($promotions as $promotion)
                        <div class="bg-red mb-3" style="border-radius: 20px" data-aos="fade-up" >
                            <div class="container-xl">
                                <div class="row">
                                    <div class="col-md-6 d-flex px-3 py-3">
                ...
                @if ($all == true)
                    ...
                    <div class="row justify-content-center">
                        <div class="col-4 text-center">
                            <a href="{{route('5bdf.wingers.promotions',['all' => 'true'])}}" class="btn bg-red text-white">
                                View More
                            </a>
                        </div>
                    </div>
